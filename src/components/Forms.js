  ...
  return(
    <div className={`form ${isSubmit? 'formAndData' :''}`}>
      <form onSubmit={handleSubmit}>
          ...
          <label>
            <p>Years in School</p>
            <select className="select" name ="Years" onChange={handleChange} value={formData.Years}>
        ...
        <label className="state">
          ...
          <label>
           ...
           <label>
            ...
            <input className="input" type="number" name="Budget" placeholder="$0.00" min="0" max="100000" onChange={handleChange} required value={formData.Budget}/>
          </label>
           <label>
            <p>Amount From Salary (%)</p>
            <input className="input"  type="number" name="percent_income" min="0" max="100" placeholder="% 0" onChange={handleChange} required value={formData.percent_income} />
          </label>
           <label>
            <p>Interest Rate (%)</p>
            <input className="input formLast"  type="number" name="interest_rate" min="0" max="50" placeholder="% 0" onChange={handleChange} required value={formData.interest_rate} />
          </label>
