...
function Privacy() {
    const links =
    {
        disableAdobe: "https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_",
        GA: "https://policies.google.com/privacy",
    }
    return (
    <div className="Privacy-container">
        ...
        <div className="paragraph-section">
        <h3 className="page-header">Collecting and Using Your Personal Data:</h3>
        <h3 className="page-header">(Types of Data Collected)</h3>
        <h3 className="page-subheader">Personal Data</h3>
        <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
        <ul className="list-style">
            <li>Usage Data</li>
        </ul>
        <h3 className="page-subheader">Usage Data</h3>
        ...
        <ul className="list-style">
            ...
            <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. 
                For more information on how You can delete Flash Cookies, please read &quot;Where can I change the settings for disabling, or deleting local shared objects?&quot; available at <a className="link" href={links.disableAdobe} rel="external nofollow noopener noreferrer" target="_blank">Adobe Flash Cookies</a></li>
        ...
        <h2 className="page-subheader">Use of Your Personal Data</h2>
        ...
        <ul className="list-style">
            ...
            <h3 className="page-subheader">Retention of Your Personal Data</h3>
            ...
            <h3 className="page-subheader">Transfer of Your Personal Data</h3>
            <p>Your information, including Personal Data, is processed at the Company's operating offices and in any other places where the parties involved in the processing are located. 
                It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.</p>
            ...
            The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization 
    ...
    <div className="paragraph-section">
        <h3 className="page-header">Disclosure of Your Personal Data</h3>
        <h3 className="page-subheader">Business Transactions</h3>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
        <h3 className="page-subheader">Law enforcement</h3>
        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        <h3 className="page-subheader">Other legal requirements</h3>
        ...
        <h3 className="page-subheader">Security of Your Personal Data</h3>
        <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
    </div>
    <div className="paragraph-section">
        <h3 className="page-header">Detailed Information on the Processing of Your Personal Data</h3>
        <p>The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>
        <h3 className="page-subheader">Analytics</h3>
        ...
        <ul className="list-style">
            ...
            <p>For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page: <a className="link" href={links.GA} rel="external nofollow noopener noreferrer">https://policies.google.com/privacy</a></p>
            </li>
        </ul>
    </div>
    <h3 className="page-header">Changes to this Privacy Policy</h3>
    <div className="paragraph-section">
    ...
    <div className="paragraph-section">
        <h3 className="page-header">Links to Other Websites</h3>
    ...
    <div className="paragraph-section">
        ...
        <p>By email: <strong>contact@calculatestudentloans.com</strong></p>
    </div>
    </div>
